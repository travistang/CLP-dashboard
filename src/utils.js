...
var userpool_id = 'ap-southeast-1_eSGrD04Po';
var app_client_id = '61at0ougqh0k0tv4unvmkjvble';
var keys_url = 'https://cognito-idp.' + region + '.amazonaws.com/' + userpool_id + '/.well-known/jwks.json';


export const parseToken = (event,context,callback) => {
  var token = event.token
  var sections = token.split('.')
  var info = JSON.parse(jose.util.base64url.decode(sections[1]))
  callback('',info.email)
}
// export const parseToken = (event, context, callback) => {
//     var token = event.token;
